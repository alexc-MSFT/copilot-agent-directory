...
This document lists all 1P (1st Party) and 3P (3rd Party) Copilot agents from the Copilot Agent Store, including their name, description (where available), and any relevant department/persona information.
